...
class LarkDocument:
    """Represents a Lark grammar document with parsing and analysis capabilities."""
    ...
    def __init__(self, uri: str, source: str) -> None:
        ...
        self._references: Dict[str, List[Tuple[int, int]]] = {}  # name -> [(line, col), ...]
    ...
    def _analyze(self) -> None:
        ...
        try:
            ...
            self._add_diagnostic(0, 0, f"Analysis error: {str(e)}", DiagnosticSeverity.Error)
    ...
    def _parse_grammar(self) -> None:
        ...
        try:
            ...
            if hasattr(e, 'line') and hasattr(e, 'column'):
                ...
                self._add_diagnostic(line, col, f"Parse error: {str(e)}", DiagnosticSeverity.Error)
            else:
                self._add_diagnostic(0, 0, f"Parse error: {str(e)}", DiagnosticSeverity.Error)
    ...
    def _validate_references(self) -> None:
        ...
        for line_num, line in enumerate(self.lines):
            ...
            for match in re.finditer(r'\b([a-z_][a-z0-9_]*)\b', line):
                ...
                if name in ['start', 'import', 'ignore', 'override', 'extend', 'declare']:
                    continue
    ...
    def _add_diagnostic(self, line: int, col: int, message: str, severity: DiagnosticSeverity) -> None:
        ...
        line_text = self.lines[line] if line < len(self.lines) else ""
    ...
    def get_completions(self, line: int, col: int) -> List[CompletionItem]:
        ...
        keywords = [
            "start", "import", "ignore", "override", "extend", "declare"
        ]
